 ...
 * invitation codes, store shard numbers.
 * <p>
 ...
 * @since 0.3.3
 */
@SuppressWarnings({"ALL", "AlibabaAvoidPatternCompileInMethod"})
public class Hashids {
    ...
    private static final String DEFAULT_ALPHABET = "23456789abcdefghjkmnpqrstuvwxyz";
    private static final String DEFAULT_SEPS = "";
    private static final String DEFAULT_SALT = "";
    private static final int DEFAULT_MIN_HASH_LENGTH = 5;
